...
I am interested in automating discovery in science and engineering. My current research explores:
- **LLM agents** for open-ended search, code evolution, and generative algorithm discovery
- **Bayesian decision-making**, including **Bayesian optimization** and **Gaussian processes** for sample-efficient black-box optimization and uncertainty quantification
