...
Most AI systems today are constrained by fixed architectures designed by humans and are unable to improve themselves autonomously and continuously. This is the [Achilles heel](https://en.wikipedia.org/wiki/Achilles%27_heel) of modern AI — like a car, no matter how well the engine is tuned and how skilled the driver is, it cannot change its body structure or engine type to fit a new track on its own. But what if AI could build on the past and drive itself toward more advanced and more general capabilities through self-improvement? In this post, we will dive into the concept of a self-improving system and a recent effort towards building one.
...
<img src="{{ '/assets/img/godel.jpg' | relative_url }}" alt="Overview of a Gödel machine" class="center" width="80%" class="l-body rounded z-depth-1 center">
...
<img src="{{ '/assets/img/dgm.png' | relative_url }}" alt="Overview of the DGM" class="center" width="80%" class="l-body rounded z-depth-1 center">
<div class="l-gutter caption" markdown="1">
...
### How DGM Works
<img src="{{ '/assets/img/dgm-animation.gif' | relative_url }}" alt="Animation of the DGM process" class="center" width="80%" class="l-body rounded z-depth-1 center">
<div class="l-gutter caption" markdown="1">
...
Interested readers can refer to my [previous post](https://posteriorupdate.github.io/blog/2025/llm-algorithm-discovery/) for a comprehensive overview of AlphaEvolve and its comparison with its predecessor, FunSearch.
</aside>
